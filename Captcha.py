...
Title_Label = Label(Tops, font=('Comic Sans MS', 16, 'bold'),
                    text="             CAPTCHA Generator\t\t", bg='black',
                    fg='white', justify="center")
Title_Label.grid(row=0, column=0)
MainFrame = Frame(root, bg='#05c4bc', pady=2, width=1350, height=100, relief=RIDGE)
...
Label_1 = Label(RightFrame, font=('lato black', 33, 'bold'), text=" Audio Captcha ", padx=2, pady=2, bg="yellow",
                fg="black")
...
Label_1 = Label(LeftFrame, font=('lato black', 33, 'bold'), text=" Image Captcha ", padx=2, pady=2, bg="yellow",
                fg="black")
Label_1.grid(row=0, column=0, sticky=W)
